...
This package now uses the modern Python packaging standard in `pyproject.toml`, so it can be installed with `uv`, `pip`, and other PEP 517/518-compatible installers.
